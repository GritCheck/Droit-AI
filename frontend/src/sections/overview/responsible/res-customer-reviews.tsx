...
export function ResCustomerReviews({ title, subheader, list, sx, ...other }: Props) {
  ...
  return (
    <Card sx={sx} {...other}>
      <CardHeader title={title} subheader={subheader} action={<CarouselArrowBasicButtons {...carousel.arrows} />} />
