...
const ITEMS = [
  {
    ...
    title: 'Azure-Powered Search',
    description: 'Enterprise-grade Azure AI Search with semantic ranking and hybrid vector capabilities.',
  },
  {
    icon: `${CONFIG.assetsDir}/assets/icons/home/ic-design.svg`,
    title: 'Verifiable Citations',
    description: 'Exact page numbers and source references for every AI-generated answer.',
  },
  {
    icon: `${CONFIG.assetsDir}/assets/icons/home/ic-development.svg`,
    title: 'Enterprise Security',
    description: 'Azure AD integration with role-based access and complete audit trails.',
  },
];
