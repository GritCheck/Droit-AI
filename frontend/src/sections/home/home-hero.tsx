...
export function HomeHero({ sx, ...other }: BoxProps) {
  ...
  const renderText = () => (
    <m.div {...motionProps}>
      ...
      >
        {`Get accurate, verifiable answers from your documents. 
Azure-powered RAG system with enterprise security and real-time citations.`}
      </Typography>
    </m.div>
  );
  ...
  const renderRatings = () => (
    <m.div {...motionProps}>
      ...
      >
        ...
        500+ Enterprise queries processed
      </Box>
    </m.div>
  );
