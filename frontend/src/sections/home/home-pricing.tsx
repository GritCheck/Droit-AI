...
export function HomePricing({ sx, ...other }: BoxProps) {
  ...
  const renderDescription = () => (
    <SectionTitle
      caption="RAG Solutions"
      title="Flexible"
      txtGradient="Pricing"
      description="Choose the perfect RAG solution for your organization. Enterprise-grade AI search with transparent pricing and no hidden costs."
    ...
    <MotionViewport>
      ...
      >
        ...
        <m.div variants={varFade('inUp', { distance: 24 })}>
          <Button
            fullWidth
            variant={plan.license === 'Enterprise' ? 'contained' : 'outlined'}
            color="primary"
            size="large"
            target="_blank"
            rel="noopener"
...
const PLANS = Array.from({ length: 3 }, (_, index) => ({
  license: ['Starter', 'Professional', 'Enterprise'][index],
  price: [2500, 4500, 8500][index],
  speed: ['1K docs', '10K docs', 'Unlimited docs'][index],
  commons: [
