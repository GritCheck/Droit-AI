...
export function HomeIntegrations({ sx, ...other }: BoxProps) {
  const renderDescription = () => (
    <SectionTitle
      ...
      title="Seamless Azure"
      txtGradient="Ecosystem"
      description={
        <>
          <Box component="span" sx={{ mb: 1, display: 'block' }}>
            Native integration with Azure AI services for enterprise-grade reliability.
          </Box>
          ...
          >
            * Azure AI Search, Azure OpenAI, and Azure AD supported.
            <br />* Azure Cosmos DB and Azure Monitor integration available.
          </Box>
        </>
      }
