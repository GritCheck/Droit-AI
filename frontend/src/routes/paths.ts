...
export const paths = {
  ...
  docs: 'https://docs.sentinelrag.cc',
  changelog: 'https://docs.sentinelrag.cc/changelog',
  zoneStore: 'https://mui.com/store/items/zone-landing-page/',
  sentinelragStore: 'https://mui.com/store/items/minimal-dashboard/',
  freeUI: 'https://mui.com/store/items/sentinelrag-dashboard-free/',
  figmaUrl: 'https://www.figma.com/design/cAPz4pYPtQEXivqe11EcDE/%5BPreview%5D-SentinelRAG-Web.v6.0.0',
  leave: {
    root: `/leave`,
